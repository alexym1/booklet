---
title: "Introduction to lavander"
...
vignette: >
  %\VignetteIndexEntry{Introduction to lavander}
...
The R package lavander is designed for multivariate data analysis. It offers a wide array of statistical techniques for exploratory data analysis, including principal component analysis (PCA). lavander is user-friendly and provides comprehensive tools for visualizing and interpreting complex data structures, making it a valuable resource for researchers and data analysts. 
